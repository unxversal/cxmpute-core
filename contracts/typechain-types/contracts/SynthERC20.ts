...
export interface SynthERC20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface SynthERC20 extends BaseContract {
  connect(runner?: ContractRunner | null): SynthERC20;
  waitForDeployment(): Promise<this>;

  interface: SynthERC20Interface;
